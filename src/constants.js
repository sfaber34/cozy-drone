...
// props (rocks, brush, tumbleweed, etc.), and the HUD/mini-map overlay so the
// desert renders as flat dirt with a clean viewport — useful for capturing
// art screenshots. Flip back to false afterward.
...
export const FARM_FIELD_TRACTOR_TURN_DURATION = 3; // seconds to complete each U-turn at the strip edge
...
export const FARM_FIELD_ANIMAL_PIGS = 7;
export const FARM_FIELD_ANIMAL_CHICKENS = 15;
export const FARM_FIELD_ANIMAL_CAMELS = 5;
export const FARM_FIELD_ANIMAL_SHEEP = 8; // uses goat texture as a sheep stand-in
...
export const BUILDING_RADIUS_MEDIUM = 55;
