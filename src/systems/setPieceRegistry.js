...
export const SET_PIECE_META = {
  ...
  // farmCompound: corrals at farmX-448..+598, silos above fence at farmY-408.
  //   Full box [-448, +598] × [-408, +320]; center offset = (+75, -44).
  farmCompound: { factory: createFarmCompound, hw: 523,  hh: 364,  anchorOffsetX: 75,   anchorOffsetY: -44  },
